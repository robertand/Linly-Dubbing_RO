...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Intelligent Multi-language AI Dubbing/Translation Tool - Linly-Dubbing")
        ...
        # Connect configuration change signal from settings page to one-click automation page
        ...
        self.tab_widget.addTab(TTSTab(), "AI Speech Synthesis")
        self.tab_widget.addTab(SynthesizeVideoTab(), "Video Synthesis")
        self.tab_widget.addTab(LinlyTalkerTab(), "Linly-Talker Lip-Sync (Developing)")
