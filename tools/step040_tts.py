...
def preprocess_text(text):
    ...
    # Insert spaces between letters and numbers using regex
...
def generate_wavs(method, folder, target_language='Chinese', voice = 'zh-CN-XiaoxiaoNeural'):
...
def generate_all_wavs_under_folder(root_folder, method, target_language='Chinese', voice = 'zh-CN-XiaoxiaoNeural'):
